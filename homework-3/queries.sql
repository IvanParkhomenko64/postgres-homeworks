...
SELECT company_name, CONCAT(first_name, ' ', last_name) AS Full_name FROM orders
INNER JOIN customers USING(customer_id)
INNER JOIN employees USING(employee_id)
WHERE customers.city = 'London' and employees.city = 'London' and orders.ship_via IN (SELECT shipper_id FROM shippers WHERE company_name = 'United Package')
